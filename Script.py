...
‣ ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://telegram.me/AmalSerTG'>ɢᴏᴅx</a></b>
"""

    GSTART_TXT = """<b>ʜᴇʏ {},\n\nɪ ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ᴘʀᴇᴍɪᴜᴍ ꜰᴇᴀᴛᴜʀᴇꜱ.\n\nᴍᴀɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="t.me/AmalSerTG">ɢᴏᴅx </a></b>"""

    HELP_TXT = """<b>ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴇsᴄʀɪᴘᴛɪᴏɴ ᴀʙᴏᴜᴛ sᴘᴇᴄɪғɪᴄs ᴄᴏᴍᴍᴀɴᴅ!</b>"""
 
    ABOUT_TXT = """
<b>❍ ᴍʏ ɴᴀᴍᴇ : <a href="https://t.me/">ᴇʟᴢᴀ</a>
❍ ᴄʀᴇᴀᴛᴏʀ : <a href="https://t.me/AmalSerTG">ɢᴏᴅx </a>
❍ ʟɪʙʀᴀʀʏ : <a href="https://pyrogram.org/">ᴘʏʀᴏɢʀᴀᴍ</a>
❍ ʟᴀɴɢᴜᴀɢᴇ : <a href="https://www.python.org/">ᴘʏᴛʜᴏɴ</a>
❍ ᴅᴀᴛᴀʙᴀꜱᴇ : <a href="https://www.mongodb.com/">ᴍᴏɴɢᴏ ᴅʙ</a>
❍ ʜᴏꜱᴛᴇᴅ ᴏɴ : <a href="https://t.me/AmalSerTG">ᴠᴘs</a>
...
ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="t.me/AmalSerTG">ɢᴏᴅx </a></b>"""
...
➢ <a href='t.me/AmalSerTG'>ғᴀᴍᴘᴀʏ</a>

ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ ғᴏʀ ᴋɴᴏᴡ ᴀʙᴏᴜᴛ ᴛʜᴇ ᴘᴀʏᴍᴇɴᴛ ɪɴғᴏ

<b>ᴄʟɪᴄᴋ ʜᴇʀᴇ - <a href='https://telegram.me/AmalSerTG'>ᴏᴡɴᴇʀ</a></b>"""

    SUBSCRIPTION_TXT = """
<b>ʀᴇғᴇʀʀᴇ ʏᴏᴜʀ ʟɪɴᴋ ᴛᴏ ʏᴏᴜʀ ғʀɪᴇɴᴅs, ғᴀᴍɪʟʏ, ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ɢʀᴏᴜᴘ ᴛᴏ ɢᴇᴛ ғʀᴇᴇ ᴘʀᴇᴍɪᴜᴍ ғᴏʀ {}

ʀᴇғᴇʀᴀʟ ʟɪɴᴋ - https://telegram.me/{}?start=Elza-{}
...
𝟹. ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴs /admin</b>"""
...
<code>/ytthumb https://youtu.be/link</code>"""
...
<code>/mp4 https://youtu.be/mp4</code>

<code>/video https://youtu.be/mp3</code>"""
...
╰─➩ ᴍʏ ɴᴀᴍᴇ - ɢᴏᴅx (real name *****)
╰─➩ ᴜsᴇʀɴᴀᴍᴇ - <a href='https://t.me/AmalSerTG'>ᴄɪɴᴇꜰʟɪx</a>
╰─➩ ᴘᴍ. ᴅᴍ ʟɪɴᴋ - <a href='https://t.me/AmalSerTG'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>
╰─➩ ᴅᴏʙ - 00 | 00 | 0000
╰─➩ ʟᴇᴠᴇʟ - 1
╰─➩ ᴀɢᴇ - ∞
...
ᴇxᴀᴍᴘʟᴇ ;- <code>/repo/allrepo ᴄɪɴᴇꜰʟɪx</code>"""
...
💵 ᴜᴘɪ ɪᴅ - <code>dm - @amalsertg</code>
📸 ǫʀ ᴄᴏᴅᴇ - <a href='https://i.ibb.co/fqRF4PK/glitch-20240611-005845-0000.png'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/AmalserTg'>ᴏᴡɴᴇʀ</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
"""
    ...
    LOGO = """ BOT DEPLOYED BY @AmalSerTG"""

# dont remove logo

#- ᴄʀᴇᴅɪᴛ - Github - @Codeflix-bots , @erotixe
#- ᴘʟᴇᴀsᴇ ᴅᴏɴ'ᴛ ʀᴇᴍᴏᴠᴇ ᴄʀᴇᴅɪᴛ..
#- ᴛʜᴀɴᴋ ʏᴏᴜ ᴄɪɴᴇꜰʟɪx  ʙᴏᴛs ғᴏʀ ʜᴇʟᴘɪɴɢ ᴜs ɪɴ ᴛʜɪs ᴊᴏᴜʀɴᴇʏ 
